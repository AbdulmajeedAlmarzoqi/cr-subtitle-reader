...
- The app is now built from an Xcode project (generated from `project.yml` with XcodeGen); the release script archives, signs, notarizes and staples through Xcode.
