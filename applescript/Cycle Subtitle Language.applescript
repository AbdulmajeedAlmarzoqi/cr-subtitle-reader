(*
	CR Subtitle Reader — Cycle Subtitle Language
	Switches to the next available subtitle language by sending a command to the CR Subtitle Reader userscript
